...
const jsonHeaders = {
    ...
    'Access-Control-Allow-Headers': 'Content-Type, puter-auth, Authorization',
};
...
router.options('/api/projects/save', async () => optionsResponse())
router.options('/api/projects/list', async () => optionsResponse())
router.options('/api/projects/get', async () => optionsResponse())
